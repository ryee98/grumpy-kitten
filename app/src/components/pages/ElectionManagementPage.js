...
export const ElectionManagementPage = (props) => {
    const { onRefreshElections, onSubmitBallotItem, elections, electionQuestions, onSubmitElection, onUpdate} = props;
    ...
    return ( <>
            ...
            <section>
                ...
                <ElectionForm onSubmitElection={onSubmitElection} electionQuestions={electionQuestions} onSubmitBallotItem={onSubmitBallotItem} onUpdateElection={onUpdate}  buttonText="Save Election"/>
            </section>
        </>
    );
}